...
import com.example.ebookshare.entity.Orderdetails;
import com.example.ebookshare.entity.Orders;
import com.example.ebookshare.entity.Users;
import com.example.ebookshare.service.IOrderdetailsService;
import com.example.ebookshare.service.IOrdersService;
...
public class OrderdetailsController {
    ...
    public Result comment(@PathVariable Integer productId){
        ...
        for (Orderdetails orderdetails:list){
            ...
            Users members = usersService.getById(memberId);
            if (StrUtil.isNotBlank(orderdetails.getComment())){
                comments.add(Dict.create().set("avatar",members.getAvatarurl()).set("member",members.getUsername()).set("comment",orderdetails.getComment()));
            }
        }
