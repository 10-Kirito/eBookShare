      ...
      <div style="margin-left: 10px;flex: 1">
        <el-card>
          <el-form label-width="80px">
            ...
            <el-form-item label="积分价格"><span style="color: red" >{{product.price}} /{{product.unit}}</span></el-form-item>
            <el-form-item label="商品库存"><span>{{product.nums}} {{product.unit}}</span></el-form-item>
