    ...
    <div style="margin: 10px 0">
      ...
      <el-row :gutter="10">
        <el-col :span="6" v-for="item in products" :key="item.id" style="margin-bottom: 10px">
          <div style="background-color: white;padding: 10px;cursor: pointer" @click="$router.push('/shop/detail?id='+item.id)">
            ...
            <div style="margin: 10px 0;color:red;font-weight: bold;font-size: 14px">{{item.price}} 积分</div>
          </div>
        </el-col>
      </el-row>
