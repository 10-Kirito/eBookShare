...
<script>
import Headbg from '../module/Head-bg';
import Headbar from '../module/Head-bar';
...
export default {
  name: "home",
  components:{ Headbg, Container,Footer,Headbar  },
  data () {
    return {
      isShow:false,
    };
  ...
  mounted(){
    window.addEventListener('scroll',this.changeIsShow);
  }
}
</script>
